...
(function ($) {
      ...
      if (this.$e.attr("data-triggerOn") === undefined) {
        ...
        this.$e.before(
          '<button type="button" class="btn btn-light ' +
            ...
            b +
            ' style="width: 100%; margin-top: 0.5em; margin-bottom: 1em;"><span class="text"></span> <span class="caret"></span></button>'
        );
    ...
    _updateBtnCount: function () {
      ...
      if (
        ...
        var a = this.$triggerElement.find(".text"),
          b =
            this.$triggerElement.next().find("option:selected").text() ||
            this.$e.val(),
  ...
  $.fn.mobileSelect.defaults = {
    template:
      '<div><div class="mobileSelect-title"></div><div class="list-container"></div><div class="mobileSelect-buttons"><a href="#" class="mobileSelect-clearbtn"></a><a href="#" class="mobileSelect-cancelbtn" style="color: #dc3545"></a><a href="#" class="mobileSelect-savebtn"></a></div></div>',
